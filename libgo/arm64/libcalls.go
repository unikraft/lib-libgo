...
// Automatically generated wrapper for prlimit/prlimit
//go:noescape
//extern-sysinfo prlimit
func c_prlimit(pid Pid_t, resource _C_int, newlimit *Rlimit, oldlimit *Rlimit) _C_int
func prlimit(pid int, resource int, newlimit *Rlimit, oldlimit *Rlimit) (err error) {
	Entersyscall()
